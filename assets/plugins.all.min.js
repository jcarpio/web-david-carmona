...
(new Date).getTime())).attr("scrolling",s?"auto":a.iframe.scrolling).attr("src",a.href);f(a.wrap).bind("onReset",function(){try{f(this).find("iframe").hide().attr("src","//web.archive.org/web/20200205134352/https://about:blank").end().empty()}catch(a){}});a.iframe.preload&&(b.showLoading(),d.one("load",function(){f(this).data("ready",1);s||f(this).bind("load.fb",b.update);f(this).parents(".fancybox-wrap").width("100%").removeClass("fancybox-tmp").show();b._afterLoad()}));a.content=d.appendTo(a.inner);a.iframe.preload||b._afterLoad()},_preloadImages:function(){var a=
...
/*
     FILE ARCHIVED ON 13:43:52 Feb 05, 2020 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.011
  cdx.remote: 4.129
  LoadShardBlock: 70.995 (3)
  PetaboxLoader3.datanode: 237.444 (5)
  load_resource: 413.967 (2)
  PetaboxLoader3.resolve: 198.485 (2)
*/